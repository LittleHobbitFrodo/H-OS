...
#pragma once
	...
	void* align_alloc(size_t bytes, size_t* align_) __attribute__((nonnull(2), returns_nonnull));
	void* align_alloco(size_t bytes, size_t* align) __attribute__((nonnull(2), returns_nonnull));
	...
	void* heap_align_enlargeo(size_t bytes, size_t* align_) __attribute__((nonnull(2), returns_nonnull));
	void* heap_align_expando(size_t bytes, size_t* align_) __attribute__((nonnull(2), returns_nonnull));
